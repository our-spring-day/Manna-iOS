...
let iuzzang = User(name: "아이유", profileImage: "iu", checkedFlag: false)
let jenny = User(name: "제니", profileImage: "jenny", checkedFlag: false)
let jisoo = User(name: "지수", profileImage: "jisoo", checkedFlag: false)
let jpark = User(name: "박재범", profileImage: "j-park", checkedFlag: false)
let crush = User(name: "크러쉬", profileImage: "crush", checkedFlag: false)
let bloo = User(name: "블루", profileImage: "bloo", checkedFlag: false)
let rain = User(name: "비", profileImage: "rain", checkedFlag: false)
let kimwoobin = User(name: "김우빈", profileImage: "kimwoobin", checkedFlag: false)
let kingkihoon = User(name: "킹기훈", profileImage: "kingkihoon", checkedFlag: false)
let munchan2 = User(name: "정문찬", profileImage: "munchan2", checkedFlag: false)
